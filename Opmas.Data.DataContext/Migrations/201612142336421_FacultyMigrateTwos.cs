namespace Opmas.Data.DataContext.Migrations
{
    ...
    public partial class FacultyMigrateTwos : DbMigration
    {
        public override void Up()
        {
            ...
            AddForeignKey("dbo.EmployeeWorkDatas", "EmployeeId", "dbo.Employees", "EmployeeId", cascadeDelete: false);
            AddForeignKey("dbo.EmployeePersonalDatas", "StateId", "dbo.States", "StateId", cascadeDelete: false);
            AddForeignKey("dbo.EmployeePersonalDatas", "LgaId", "dbo.Lgas", "LgaId", cascadeDelete: false);
            AddForeignKey("dbo.Lgas", "StateId", "dbo.States", "StateId", cascadeDelete: false);
            AddForeignKey("dbo.EmployeePersonalDatas", "EmployeeId", "dbo.Employees", "EmployeeId", cascadeDelete: false);
            AddForeignKey("dbo.EmployeePastWorkExperiences", "EmployeeId", "dbo.Employees", "EmployeeId", cascadeDelete: false);
            AddForeignKey("dbo.EmployeeMedicalDatas", "EmployeeId", "dbo.Employees", "EmployeeId", cascadeDelete: true);
            AddForeignKey("dbo.EmployeeEducationalQualifications", "EmployeeId", "dbo.Employees", "EmployeeId", cascadeDelete: false);
            AddForeignKey("dbo.EmployeeBankDatas", "EmployeeId", "dbo.Employees", "EmployeeId", cascadeDelete: false);
            AddForeignKey("dbo.EmployeeBankDatas", "BankId", "dbo.Banks", "BankId", cascadeDelete: false);
